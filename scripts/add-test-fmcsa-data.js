/**
 * Script to add test FMCSA data for DOT 3512175 (Leader Group Inc)
 */
...
// Insert carrier info for DOT 3512175
const dotNumber = 3512175;
...
const carrierData = {
  dotNumber: dotNumber,
  legalName: 'Leader Group Inc',
  street: '1234 Main Street',
  city: 'Dallas',
  state: 'TX',
  zip: '75201',
  phone: '(214) 555-1234',
  email: 'safety@leadergroup.com',
  mcs150Date: '2023-06-15', // About 2.5 years ago (should trigger update recommendation)
...
const violations = [
  {
    date: '2024-10-15',
    type: '395.3A1',
    description: 'Driver failed to maintain daily log',
    severity: 'high',
  ...
  },
  {
    date: '2024-09-22',
    type: '396.3A1',
    description: 'Brake system defect - air leak',
    severity: 'high',
  ...
  },
  {
    date: '2024-07-05',
    type: '393.45',
    description: 'Defective brake adjustment',
    severity: 'medium',
    basic: 'Vehicle Maintenance',
    oos: 'N',
    count: 1,
  },
  {
    date: '2024-06-18',
    type: '391.11B2',
    description: 'Driver qualification file incomplete',
    severity: 'medium',
  ...
  },
  {
    date: '2024-04-03',
    type: '396.3A1',
    description: 'Tire tread depth below minimum',
    severity: 'medium',
    basic: 'Vehicle Maintenance',
    oos: 'N',
    count: 1,
...
console.log(`   You can now test with submission ID: 3f6d524a-1de6-4f32-8b75-ee0784c26e25\n`);
